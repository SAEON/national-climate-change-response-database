...
ARG SAEON_AUTH_OAUTH_REDIRECT_ADDRESS
ENV SAEON_AUTH_OAUTH_REDIRECT_ADDRESS=$SAEON_AUTH_OAUTH_REDIRECT_ADDRESS
...
CMD \
  ...
  SAEON_AUTH_OAUTH_REDIRECT_ADDRESS=$SAEON_AUTH_OAUTH_REDIRECT_ADDRESS \
