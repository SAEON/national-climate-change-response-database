...
create table Projects (
  ...
  description nvarchar(4000),
	...
	projectManagerPhysicalAddress nvarchar(255),
	projectManagerPostalAddress nvarchar(255),
...
create table Mitigations (
  id int not null identity primary key,
	...
	correspondingNationalPolicy int foreign key references VocabularyXrefTree (id),
	correspondingSubNationalPolicy int foreign key references VocabularyXrefTree (id),
...
create table Adaptations (
  id int not null identity primary key,
	...
	correspondingNationalPolicy int foreign key references VocabularyXrefTree (id),
	correspondingSubNationalPolicy int foreign key references VocabularyXrefTree (id),
	correspondingAction int foreign key references VocabularyXrefTree (id),
