...
import saveActiveSubmission from '../mutations/save-active-submission/index.js'
...
export default {
  ...
  saveActiveSubmission: authorize(PERMISSIONS.createProject)(saveActiveSubmission), // TODO - new permission?
}
